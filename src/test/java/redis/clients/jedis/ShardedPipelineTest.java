...
public class ShardedPipelineTest {
  ...
  public void shardedPipelineSync() {
    try (ShardedConnectionProvider provider = new ShardedConnectionProvider(shards, DEFAULT_CLIENT_CONFIG)) {
      ...
      Assertions.assertEquals("OK", r1.get());
      Assertions.assertEquals("OK", r2.get());
      Assertions.assertEquals("OK", r3.get());
      Assertions.assertEquals("value1", r4.get());
      Assertions.assertEquals("value2", r5.get());
      Assertions.assertEquals("value3", r6.get());
    }
  }
