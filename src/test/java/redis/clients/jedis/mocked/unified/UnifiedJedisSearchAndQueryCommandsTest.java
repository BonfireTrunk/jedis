...
public class UnifiedJedisSearchAndQueryCommandsTest extends UnifiedJedisMockedTestBase {
  ...
  public void testFtProfileAggregate() {
    ...
    Map.Entry<AggregationResult, ProfilingInfo> result = jedis.ftProfileAggregate(indexName,
      profileParams, aggr);
  ...
  public void testFtProfileSearchWithQueryObject() {
    ...
    Map.Entry<SearchResult, ProfilingInfo> result = jedis.ftProfileSearch(indexName,
      profileParams, query);
