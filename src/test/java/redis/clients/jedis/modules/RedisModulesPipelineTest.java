...
public class RedisModulesPipelineTest extends RedisModuleCommandsTestBase {
  ...
  public void search() {
    ...
    // Response<SearchResult> searchBytesResult = p.ftSearch(index.getBytes(), new
    // Query("hello world")); // not RESP3 supported
  ...
  public void jsonV2() {
    ...
    Response<List<Long>> indexWithEscape = p
        .jsonArrIndexWithEscape("foo", Path2.of("$.array"), "b");
